package net.cloud95.android.lession.ch0505activitytransitions;
...
public class MainActivity extends Activity {
	...
	public void onClick(View v) {
		...
		// Activity 轉場動畫
		startActivity(intent,ActivityOptions.makeSceneTransitionAnimation(this,findViewById(v.getId()),v.getTag().toString()).toBundle());
	}
}
